...
이 프로젝트는 검색 엔진 최적화(SEO)를 위해 다음과 같은 기능들이 구현되어 있습니다:

### 메타 태그 최적화
- **제목 태그**: 명확하고 키워드가 포함된 제목
- **메타 설명**: 검색 결과에 표시될 설명
- **키워드**: 관련 키워드 메타 태그
- **언어 설정**: 한국어(`ko`) 설정

### Open Graph 태그
- **소셜 미디어 공유**: Facebook, Twitter 등에서 최적화된 미리보기
- **이미지**: 공유 시 표시될 이미지
- **제목 및 설명**: 소셜 미디어용 최적화된 텍스트

### 구조화된 데이터
- **JSON-LD 스키마**: 검색 엔진이 콘텐츠를 이해하기 쉽도록 구조화
- **WebApplication 스키마**: 웹 애플리케이션 정보 제공

### 기술적 최적화
- **시맨틱 HTML**: 의미론적으로 올바른 HTML 구조
- **접근성**: ARIA 라벨 및 역할 속성
- **사이트맵**: `sitemap.xml` 제공
- **Robots.txt**: 검색 엔진 크롤링 가이드라인
- **Favicon**: 브랜딩 및 사용자 경험 개선

### 성능 최적화
- **빠른 로딩**: Vite를 통한 최적화된 빌드
- **반응형 디자인**: 모든 기기에서 최적화된 경험
- **PWA 지원**: 웹 매니페스트 파일 제공
